    ...
    <div className="h-20 w-screen border-b">
      <div className="h-full w-full bg-[#0B1215] flex justify-evenly items-center">
        ...
        <div className="h-full w-28 flex justify-end items-end">
          ...
          {/* <ModeToggle/> */} 
          <Link href='/cart'className="size-full"><div className="h-[90%] w-full flex justify-center items-center pt-3">
            <IoCartOutline className="size-[80%]"/>
            <span>{cartItem}</span>
          </div></Link>
          
            <div className="h-9 w-full bg-red-600 rounded px-1">
              <Link href='/login' className="h-full w-full flex items-center justify-center text-white font-medium text-base">LOGIN</Link>
            </div>
          </div>
        </div>
      </div>
